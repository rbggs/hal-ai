...
tags: [constitutional, changelog]
---

# Constitutional Change Log

Changes to `CLAUDE.md`, `AGENTS.md`, and other agent config files.

Format: `date | file | change | beads issue | git commit`

---

| Date | File | Change | Beads Issue | Commit |
|------|------|--------|-------------|--------|
| 2026-05-27 | CLAUDE.md | Created — audience, writing rules, code rules, project stack | — | 1ddc385 |
